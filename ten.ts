...
let  myage : string | number; // this is a union
...
//-------------------------------------------------------------------------------------
// never datatype --> jb type impossible ho jese infinite loop wo kuch return nh krega tw function 
// khtm nh hoga kbhi to kuch return bh nh krega to datatype kahan se ayegi
//-------------------------------------------------------------------------------------
